    ...
    while True:
        ...
        try:
            ...
            if response.command:
                ...
                response.command_result_output = await response.command.execute(request.mcp_manager)
                logger.info(f'Command result output: {response.command_result_output}')
            ...
            next_agent_input_parts = [
                ...
                f"OUTPUT:\t\n---\n\n{json.dumps({"user": response.user_response} if response.user_response else {"stdout":response.command_result_output.stdout, "stderr":response.command_result_output.stderr, "comment":response.command_result_output.is_safe }, indent=3, cls=JsonEncoder)}\n\n---",
